...
Const RD_ESPELHO_SG_TIPO_FULL       = 1 ;
      ...
      RD_STR_INICIO                 = 'INÍCIO' ;
      RD_STR_FINAL                  = 'FIM' ;
      RD_STR_INICIO_PREVIEW         = 'PREVIEW' ;
      RD_STR_FINAL_PREVIEW          = 'FINAL PREVIEW' ;
      RD_STR_INICIO_TRAFEGO         = 'TRÁFEGO' ;
      RD_STR_FINAL_TRAFEGO          = 'FINAL TRÁFEGO' ;
...
Type
     T_SG          = Record
                     ...
                     Nome           : String ;
                     Controlado     : Boolean ;
                     Controlador    : Boolean ;  // Determina se o SG controla a seleção de retranca
     ...
     T_RD_TELAO    = Record
                     ...
                     _Left          ,
                     _Width         ,
                     _Height        : LongInt ; // Posição e dimensões do telão
                     Tempo_TT       : LongInt ; // Tempo total de exibição
    ...
    T_Banco_Tarjas = Record
                     ...
                     End ;
     T_REG_LAUDA   = Record
                     Tipo           : LongInt ; //1-Texto 2-OBS 3-VT 4-Tarja 5-Telão
                     //PN_SECAO       : TPanel ;
                     //PN_BORDA       : TPanel ;
                     //PN_BLOCO       : TPanel ;
