...
Conversao_Video.Caption := 'Conversão de Vídeo - ' + ExtractFileName ( SB.SimpleText ) ;
...
If IS_ARQUIVO_DAV ( SB.SimpleText ) Then Begin
   ShowMessage ( 'O arquivo do tipo DAV não pode ser recortado e deve ser convertido integralmente.' ) ;
   Exit ;
End ;
