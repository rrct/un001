...
// $Rev: 52393 $
// File generated on 28/05/2016 16:57:49 from Type Library described below.
...
uses Winapi.Windows,
     System.SysUtils, System.Classes, System.Variants, System.Win.StdVCL,
     Vcl.Graphics, Vcl.OleCtrls, Vcl.OleServer, Winapi.ActiveX;
...
Try
  ...
  PUT_LOG2 ( 'WMPLib_TLB DEF URL [' + URL + ']' ) ;
  Except
  On E : Exception Do
     Begin
     PUT_LOG2 ( 'Exception WMPLib_TLB [' + E.Message + ']' ) ;
     End ;
  End ;
end;
